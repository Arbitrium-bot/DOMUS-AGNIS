...
export default function App() { const [username, setUsername] = useState(''); const [message, setMessage] = useState(''); const [statusMessage, setStatusMessage] = useState(''); const [guardMessage, setGuardMessage] = useState(''); const [guardResponse, setGuardResponse] = useState('');
...
const handleMessageSend = async () => { if (!guardMessage || !username) return; setGuardResponse('Enviando mensagem ao Guardião...');
